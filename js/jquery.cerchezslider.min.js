	...
	jQuery('.cerchez-slider:not(.cerchez-slider-init)', target).each(function() {
		...
		var $defaults = {
			...
			onSlideComplete: function (args) {
				jQuery('.item', args.sliderObject).not(args.currentSlideObject).removeClass('active');
			},
